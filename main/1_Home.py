...
from constant import info, embed_rss, endorsements
...
# load the file
documents = SimpleDirectoryReader(input_files=["main/bio.txt"]).load_data()
...
def ask_bot(input_text):
    ...
    PROMPT_QUESTION = f"""You are Chankhe, an AI assistant dedicated to assisting {name} in her job search by providing recruiters with relevant and concise information. 
    If you do not know the answer, politely admit it and let recruiters know how to contact {name} to get more information directly from {pronoun}. 
    Don't put "Chankhe" or a breakline in the front of your answer.
    Human: {input}
    """
...
def get_text():
    input_text = st.text_input("After providing OpenAI API Key on the sidebar, you can send your questions and hit Enter to know more about me from my AI agent, Chankhe!", key="input")
    return input_text
